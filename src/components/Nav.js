    ...
    <Nav>
        <div className={menuIcon ? "navbar active" : "navbar"}>
            <ul className='navbar-lists'>
                ...
                <li>
                    <NavLink className="navbar-link" to='/products' onClick={()=>setMenuIcon(false)}>Products</NavLink>
                </li>
            ...
            <div className='mobile-navbar-btn'>
                <CgMenu onClick={()=>setMenuIcon(true)} className="mobile-nav-icon" name="menu-outline"></CgMenu>
                <CgClose onClick={()=>setMenuIcon(false)} className="mobile-nav-icon close-outline" name="menu-outline"></CgClose>
            </div>
        </div>
    </Nav>
  )
